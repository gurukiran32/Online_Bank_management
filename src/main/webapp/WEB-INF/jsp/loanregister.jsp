...
<div id="container">
    ...
    <div id="content-container">
        ...
        <center>
            <br />
            <h2>Get Loan :-</h2><br /><br />
            <form name="f1" action="addloan" onsubmit="return check();" method="post">
                <b>
    ...
    <div id="aside">
        <p>* Online banking is the practice of making bank transactions or paying bills via the Internet.
            <br /><br />* Banking online allows a customer to make deposits, withdrawals, transfers with the click of a
            mouse.
